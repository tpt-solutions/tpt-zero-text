...
> **Not published to crates.io.** Overlaps `heapless::Deque`, and the standalone
> [`ringbuffer`](https://crates.io/crates/ringbuffer) / [`circular-buffer`](https://crates.io/crates/circular-buffer)
> crates, all `#![no_std]`-capable. Kept here as an internal/reference implementation.
...
```rust
use out_zero_ring::{Ring, RingFull};
