...
> [`percent-encoding`](https://crates.io/crates/percent-encoding), the ecosystem-standard,
> zero-dependency, `#![no_std]` crate used by `url`/Servo. Kept here as an
...
```rust
use out_zero_url_encode::percent_encode_into;
