...
> [`ini_core`](https://github.com/CasualX/ini_core), an explicitly `#![no_std]`, streaming
> INI parser covering the same niche. Kept here as an internal/reference implementation.
...
```rust
use out_zero_ini::{parse_into, Entry};
