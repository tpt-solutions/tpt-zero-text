...
> [`intrusive-collections`](https://crates.io/crates/intrusive-collections), a decade-mature
> `#![no_std]` crate covering lists and red-black trees. Kept here as an internal/reference
> implementation.
...
```rust
use out_zero_intrusive::{List, Link, IntrusiveNode};
